...
const Header = () => {
  ...
  const { data: searchResults, isLoading: isSearching } = useQuery({
    ...
    queryFn: () => productService.search(debouncedSearchQuery),
      ...
      <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
        ...
        >
          ...
          <div className="xl:w-auto flex-col sm:flex-row w-full flex sm:justify-between sm:items-center gap-5 sm:gap-10">
            ...
            <div className="max-w-[475px] w-full" id="search-container">
                ...
                <div className="flex items-center">
                  <div className="relative max-w-[333px] sm:min-w-[333px] w-full">
                    <input
                      ...
                      autoComplete="off"
                      className="custom-search w-full rounded-r-[5px] bg-gray-1 border border-gray-3 py-2.5 pl-4 pr-10 outline-none ease-in duration-200"
                    />
                    ...
                    {showSearchResults && searchQuery && (
                      <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-3 rounded-md shadow-lg max-h-[400px] overflow-y-auto z-50">
                        {isSearching ? (
                          ...
                          <div className="py-2">
                            {searchResults.map((product: IProduct , index: number) => (
                              <div
                                ...
                                className="px-4 py-2 hover:bg-gray-1 cursor-pointer flex items-center gap-3"
                              >
                          ...
                          <div className="p-4 text-center text-gray-4">
          ...
          <div className="flex w-full lg:w-auto items-center gap-7.5">
            ...
            <div className="flex w-full lg:w-auto justify-between items-center gap-5">
              <div className="flex items-center gap-5">
                <AccountDropdown stickyMenu={stickyMenu} />
                ...
                >
                  ...
                  <div>
                    <span className="block text-start text-2xs ml-1 text-dark-4 uppercase">
                      Giỏ hàng
                    </span>
                    <p className="font-medium text-custom-sm text-dark">
