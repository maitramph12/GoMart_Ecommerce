          ...
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex gap-4.5">
                ...
                685 Market Street,Las Vegas, LA 95820,Hoa Kỳ.
              </li>
            ...
            <div className="flex items-center gap-4 mt-7.5">
              <a
                href="#"
                aria-label="Liên kết mạng xã hội Facebook"
              ...
              <a
                href="#"
                aria-label="Liên kết mạng xã hội Twitter"
                className="flex ease-out duration-200 hover:text-blue"
              >
                <svg
                  className="fill-current"
              ...
              <a
                href="#"
                aria-label="Liên kết mạng xã hội Instagram"
                className="flex ease-out duration-200 hover:text-blue"
              >
                <svg
                  className="fill-current"
              ...
              <a
                href="#"
                aria-label="Liên kết mạng xã hội Linkedin"
                className="flex ease-out duration-200 hover:text-blue"
              >
                <svg
                  className="fill-current"
            ...
            <ul className="flex flex-col lg:items-end gap-3">
              ...
              <li>
                ...
                >
                  ...
                  <div>
                    <span className="block text-custom-xs"> Tải về từ </span>
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark font-medium">
              &copy; {year}. Bản quyền thuộc về MobileX.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="flex flex-wrap items-center gap-6">
                <a href="#" aria-label="hệ thống thanh toán bằng thẻ visa">
                  <Image
                ...
                <a href="#" aria-label="hệ thống thanh toán bằng paypal">
                  <Image
                ...
                <a href="#" aria-label="hệ thống thanh toán bằng thẻ master card">
                  <Image
                ...
                <a href="#" aria-label="hệ thống thanh toán bằng apple pay">
                  <Image
                ...
                <a href="#" aria-label="hệ thống thanh toán bằng google pay">
                  <Image
